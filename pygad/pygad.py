...
class GA(utils.parent_selection.ParentSelection,
    ...
    @property
    def gene_space_nested(self) -> bool:
        return self._gene_space_nested

    @gene_space_nested.setter
    def gene_space_nested(self, gene_space_nested):
        self._gene_space_nested = gene_space_nested
